...
$global:DAUser = Get-Credential -Credential "ncc1031\da.sqt.tester"
$global:user = New-Object System.Management.Automation.PSCredential ("ncc1031\reg.sqt.tester",$global:DAUser.Password)
$global:WAUser = New-Object System.Management.Automation.PSCredential ("ncc1031\wa.sqt.tester",$global:DAUser.Password)
$global:EAUser = New-Object System.Management.Automation.PSCredential ("ncc1031\ea.sqt.tester",$global:DAUser.Password)
$global:SAUser = New-Object System.Management.Automation.PSCredential ("ncc1031\sa.sqt.tester",$global:DAUser.Password)
$global:NAUser = New-Object System.Management.Automation.PSCredential ("ncc1031\na.sqt.tester",$global:DAUser.Password)
...
$global:memberServerOU = "*CANES Member Servers*"
$global:workstationOU = "*CANES COMPUTERS*"
